    ...
    return(
            <div className="flex flex-row h-full justify-center items-center gap-1 ">
                ...
                <div className="flex flex-row w-2/5 gap-5">
                    ...
                    <div><Link href="/Menu" className="font-inter font-normal text-white size-4 leading-6">Menu</Link></div>
                    <div><Link href="/BlogPage" className="font-inter font-normal text-white size-4 leading-6">Blog</Link></div>
                    <div><Link href="" className="font-inter font-normal text-white size-4 leading-6">Pages</Link></div>
                    <div><Link href="/About" className="font-inter font-normal text-white size-4 leading-6">About</Link></div>
                    <div><Link href="/Shop" className="font-inter font-normal text-white size-4 leading-6">Shop</Link></div>
