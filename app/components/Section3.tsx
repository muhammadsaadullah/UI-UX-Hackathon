...
export default function Section3() {
  return (
    <div className="flex flex-col px-[300px] w-screen">

        <h1 className="font-greatvibes font-normal text-center text-[32px] text-primary-orange3   ">
            Food Category
        </h1>
        <h1 className="font-roboto font-bold text-5xl mb-14 text-center text-white   ">
        ...
        <div className="grid grid-cols-4 gap-6 h-[310px] overflow-hidden   ">
            <div className="flex relative overflow-hidden rounded-md items-center justify-center h-full">
                ...
                <div className="flex absolute inset-0 z-10 flex-col justify-center items-end self-center w-[206px] h-[97px] gap-3">
